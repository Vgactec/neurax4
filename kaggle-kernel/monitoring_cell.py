"""
Code à ajouter au notebook Kaggle pour la surveillance et l'analyse
"""

# Cellule de surveillance et d'analyse
import os
import time
import threading
import logging
        ...
        try:
            ...
            with open(os.path.join("reports", report_text_filename), "w") as f:
                ...
                for phase in ["training", "evaluation", "test"]:
                    ...
                    f.write(f"  Puzzles traités: {report['phases'][phase]['processed']}/{report['phases'][phase]['total']} ({(report['phases'][phase]['processed'] / report['phases'][phase]['total'] * 100) if report['phases'][phase]['total'] > 0 else 0:.2f}%)\n")
